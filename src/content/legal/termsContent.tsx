  ...
  sections: [
    {
      ...
      paragraphs: [
        ...
        'Customer Agreements. Access to and use of the CoverForce agent portal, platform, APIs, connectors and any paid subscription (collectively, the "Platform") are governed by this Agreement except to the extent superseded by a Customer Agreement. Where you, or the entity you represent, has accepted a customer agreement with the Company covering the Platform (for independent agencies, the CoverForce Independent Agency Customer Agreement; for other customers, the applicable Master Service Agreement and Order Form) (each, a "Customer Agreement"), that Customer Agreement governs use of the Platform and controls over this Agreement to the extent of any conflict. This Agreement continues to apply to any access to or use of the Platform that is not covered by a Customer Agreement, and to every user of the Platform in their individual capacity. Nothing in this Agreement entitles you to access the Platform.',
      ],
    },
    {
      ...
      paragraphs: [
        <>
          Please read this Agreement carefully before you start to use the Website or procuring Services
          through the Website. By using the Website, procuring Services through the Website, or by
          clicking to accept or agree to this Agreement, you warrant that you have read and reviewed this
          Agreement and that you agree to be bound by this Agreement and acknowledge our{" "}
          <Link href="/privacy-policy" className="text-[#3D3D3D] underline underline-offset-2">
            Privacy Policy
          </Link>
          . If you do not agree to be bound by this Agreement, please leave the Website and do not
          attempt to purchase Services. The Company only agrees to provide the Services and use of this
          Website to you if you assent to this Agreement. This Agreement shall remain in full force and
          effect until terminated as set forth in this Agreement.
        </>,
      ],
    },
    {
      ...
      paragraphs: [
        <>
          ...
          posting the updated Agreement on the Website or by any other reasonable means. You can review
          ...
          . The Agreement in effect at the time of your use of the Website and purchase of the Services
          will apply. Updated Agreements are binding on you with respect to your use of the Website or
          purchase of Services on or after the date indicated in the updated Agreement. If you do not
          agree to the updated Agreement, you must stop using the Website and may not continue to
          purchase Services. Your continued use of the Website and purchase of Services after the date of
          the updated Agreement will constitute your acceptance of the updated Agreement.
        </>,
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        'You agree that the Website and the Services provided by Company is the property of the Company or its third-party licensors, third-party providers, consultants, agents or brokers, including all copyrights, trademarks, trade secrets, patents, and other intellectual property ("Company IP"). You agree that the Company owns all right, title and interest in and to the Company IP and that you will not use the Company IP for any unlawful or infringing purpose. You agree not to reproduce or distribute the Company IP in any way, including electronically or via registration of any new trademarks, trade names, service marks or Uniform Resource Locators (URLs), without express written permission from the Company. All documents, reports and other materials that the Company prepares or to which you are given access through the Website are the property of the Company and are Company IP for the purposes of this Section.',
      ],
    },
    {
    ...
    },
    {
      ...
      numberedItems: [
        ...
        "to reverse engineer, or attempt to reverse engineer or disassemble any code or software from or on the Website; violate the security of the Website through any unauthorized access, circumvention of encryption or other security tools, data mining or interference to any host, user or network; or",
        "to access the Website or any content on it by automated means, including scraping, crawling or bots, or to use any content on the Website (including carrier appetite, rating or product information) to develop, train, tune or improve any artificial intelligence or machine learning model or any competing product or service.",
      ],
    },
    {
      title: "10. Referral Policy.",
      paragraphs: [
        "From time to time the Company may offer referral, introduction or similar promotional programs. Any such program is offered at the Company's discretion, is governed by the terms the Company publishes for it at the time, and may be modified, suspended or terminated at any time. The Company is the sole judge of eligibility and may withhold any reward where it reasonably suspects abuse, self-referral or circumvention. In connection with any such program you may not participate in pay-per-click advertising on the Company's trademarked terms, including any derivations, variations or misspellings, for search or content-based campaigns; trademarked terms include CoverForce, CoverForce Portal and coverforce.com (all keywords apply as broad match).",
      ],
    },
    {
      title: "11. Sales.",
      paragraphs: [
        "The Company may sell Services or allow third parties to sell services on the Website. The Company undertakes to be as accurate as possible with all information regarding the Services, including product descriptions and images. However, the Company does not guarantee the accuracy or reliability of any product information, and you acknowledge and agree that you purchase such products at your own risk. Fees, billing, cancellation and refunds for any subscription to the Platform are governed exclusively by the applicable Customer Agreement and the pricing terms in effect at the time of purchase.",
      ],
    },
    {
      title: "12. Indemnification.",
      paragraphs: [
        "You agree to defend and indemnify the Company including its parent, subsidiaries directors, officers, members, owners, and employees from any third party claims and resulting liability, including attorney's fees, judgments, penalties, fines, expenses, court costs, and amounts paid arising out of or relating to use: (a) your use or misuse of the Website or Services, (b) your breach of this Agreement, or (c) your violation of any other party's rights or applicable law. We will use reasonable efforts to notify you of any claim for which we seek indemnification, provided that a failure to do so relieves you of your obligations only to the extent you are materially prejudiced. We may control the defense and settlement of any claim at your expense.",
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        "The parties agree to submit any disputes arising from, or related to, this Agreement, the Services, or use of the Website, and any disputes between the parties, including disputes arising from or concerning their interpretation, violation, invalidity, non-performance, or termination, to final and binding arbitration under the rules of arbitration of the American Arbitration Association applying New York law. The seat or legal place of arbitration will be New York City, New York. This Section is governed by the Federal Arbitration Act. You agree to arbitrate in your individual capacity only – not as a representative or member of a class – and you expressly waive any right to file a class action or seek relief on a class action basis. Furthermore, unless you and Company agree in writing, the arbitrator may not consolidate more than one person's claims, and may not otherwise preside over any form of a representative or class proceeding. The enforceability of this class action waiver shall be determined by a court and not by the arbitrator; if it is held unenforceable, this Section 19 shall be void in its entirety and disputes shall be resolved in the state and federal courts located in New York County, New York. Either party may bring an individual claim in small claims court. All arbitration proceedings are confidential, unless both you and Company agree otherwise. Arbitration orders and awards required to be filed with applicable courts of competent jurisdiction are not confidential and may be disclosed by the parties to such courts. A party who improperly discloses confidential information will be subject to sanctions. The arbitrator and forum may disclose case filings, case dispositions, and other case information as required by a court order of proper jurisdiction. Notwithstanding the foregoing, the parties may seek injunctive relief or specific performance in any court in the State of New York in order to protect its intellectual property rights or to enforce the confidentiality obligations under this Agreement without the requirement to submit the dispute to arbitration, prove monetary damages or post bond. This Agreement will be governed by and construed in accordance with the laws of the State of New York, without giving effect to its conflict of laws provisions.",
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        "The Company is not liable for any failure to perform due to causes beyond its reasonable control including, but not limited to, acts of God, acts of civil authorities, acts of military authorities, riots, embargoes, acts of nature and natural disasters, failure or unavailability of any insurance carrier, third-party model provider or third-party platform, and other acts which may be due to unforeseen circumstances.",
      ],
    },
    {
      title: "27. Electronic Communications Permitted.",
      paragraphs: [
        "Electronic communications are permitted to both parties under this Agreement, including e-mail. You consent to receive notices, disclosures and other communications from us electronically and agree that they satisfy any legal requirement that such communications be in writing. For any questions or concerns, please email Company at the following address: legal@coverforce.com.",
      ],
    },
    {
      title: "28. California Residents.",
      paragraphs: [
        "The provider of Services is CoverForce Inc., with the following contact information: 485 Madison Ave, Ste 1702, New York, NY 10022, 929-531-6480, legal@coverforce.com. If you are a California resident, in accordance with Cal. Civ. Code §1789.3, you may report complaints to the Complaint Assistance Unit of the Division of Consumer Sites of the California Department of Consumer Affairs by contacting them in writing at 1625 North Market Blvd., Suite N 112 Sacramento, CA 95834, or by telephone at (800) 952-5210 or (916) 445-1254.",
      ],
    },
  ],
  footerNote: (
    <>
      ...
      <a href="mailto:legal@coverforce.com" className="text-[#3D3D3D] underline underline-offset-2">
