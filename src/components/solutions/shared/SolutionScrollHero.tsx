  ...
  return (
    <section ref={sectionRef} className="relative z-20 bg-white text-[#0a143b]">
      ...
      <div className="pointer-events-none absolute left-0 top-0 z-0 h-svh w-[calc(100vw+2rem)] overflow-hidden">
        ...
        />
        <div
          className="absolute inset-x-0 top-0 h-[28%] bg-gradient-to-b from-black/55 via-black/25 to-transparent"
          aria-hidden
        />
        <div
          className="absolute inset-x-0 bottom-0 h-[32%] bg-gradient-to-t from-black/60 via-black/30 to-transparent"
          aria-hidden
        />
      </div>
    </section>
