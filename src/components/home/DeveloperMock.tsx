    ...
    <div
      className={
        isModal
          ...
          : "relative z-10 mx-auto w-full max-w-[460px] max-md:mt-2 max-md:w-[108%] max-md:max-w-none max-md:left-1/2 max-md:-translate-x-1/2 md:absolute md:top-1/2 md:left-auto md:right-14 md:mx-0 md:max-w-[500px] md:translate-x-0 md:-translate-y-1/2 lg:right-20"
      }
    >
