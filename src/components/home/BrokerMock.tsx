      ...
      <div className="absolute top-0 -right-20 w-full">
        ...
        <div className="px-5 pt-4 pb-3">
          ...
          <div className="mt-1 flex flex-wrap items-baseline gap-x-1 text-[#0a143b]">
            <AnimatedFortyPlus className="text-lg font-sans font-medium leading-none text-[#494646]" />
        ...
        <div className="flex items-start gap-3 px-5 pt-3 pb-4">
          ...
          >
            {chartHeights.map((barHeight, i) => (
              ...
              >
                <div
                  className="w-full origin-bottom rounded-t-[3px] will-change-[height,transform,opacity]"
                  style={{
                    ...
                    transitionDelay: animate
                      ? `${i * (cardHovered ? 24 : MICRO_CHART_STAGGER_MS)}ms`
                      : "0ms",
                  }}
                />
              </div>
      ...
      <div className="absolute bottom-0 -left-20 z-10 w-full">
        ...
        <div className="px-4 pt-3 pb-4">
          <AnimatedSixtyPercentHover
            ...
            scrollReady={animate}
            className="text-2xl font-sans font-medium leading-none text-[#494646]"
          />
            ...
            <div className="w-full pt-2">
              ...
              >
                <div
                  ...
                  style={{
                    width: animate ? `${workflowPercent}%` : "0%",
                    background:
                      "linear-gradient(90deg, #5B35E0 0%, #A78BFA 100%)",
                    transition: animate
                      ? `width ${MICRO_TAB_COLOR_MS}ms ${MICRO_EASE}`
                      : `width ${MICRO_WORKFLOW_MS}ms ${MICRO_EASE}`,
                    transitionDelay: animate
                      ? cardHovered
                        ? "0ms"
                        : `${MICRO_WORKFLOW_DELAY_MS}ms`
                      : "0ms",
                  }}
                />
              </div>
