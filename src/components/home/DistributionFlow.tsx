        ...
        <div className="relative z-10 pt-16 md:pt-20 lg:pt-24">
          ...
          >
            <div className="max-w-md">
              <h2
                ref={headingRef}
                className="mt-3 text-2xl font-heading font-medium leading-[1.15] tracking-tight text-[#BCC5D6] sm:text-3xl sm:leading-[1.12] md:mt-5 md:text-[1.625rem] md:leading-[1.12]"
              >
              ...
              <p
                ref={descRef}
                className="mt-4 max-w-md font-sans font-regular text-sm leading-[1.4] text-[#50617a] md:hidden"
              >
            ...
            <p
              className="hidden max-w-md font-sans font-regular text-sm leading-[1.4] text-[#50617a] md:mt-4 md:block md:text-[1.125rem]"
            >
              Upload emails and documents to instantly extract insurance-ready
              data with AI.
            </p>
